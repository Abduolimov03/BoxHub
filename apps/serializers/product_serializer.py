...
from apps.models import Product, Category, CoffeeAndTea, CoffeeSize
...
class CoffeeSizeModelSerializer(ModelSerializer):
    class Meta:
        model = CoffeeSize
        fields = ('size', 'price', 'preparation')


class CoffeeAndTeaModelSerializer(ModelSerializer):
    sizes = CoffeeSizeModelSerializer(many=True, read_only=True)
    category = CategoryModelSerializer(read_only=True)

    class Meta:
        model = CoffeeAndTea
        fields = ('id', 'name', 'image', 'category', 'sizes')
